...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.routeColor =RGBColor(233, 105, 105);//红色
        self.walkingColor = RGBColor(73, 179, 123);//绿色
        self.railwayColor = RGBColor(242, 178, 109);//橙色
        
        self.trafficColors = @[RGBColor(73, 179, 123), RGBColor(73, 179, 123), RGBColor(242, 178, 109), RGBColor(233, 105, 105)];
    }
